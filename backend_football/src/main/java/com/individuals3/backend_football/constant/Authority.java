...
public class Authority {
    ...
    public static final String[] REFEREE_AUTHORITIES = { "user:read", "points:update" };
    public static final String[] ADMIN_AUTHORITIES = { "user:read", "user:update", "user:create", "user:delete", "team:add", "team:delete", "points:update" };
}
