...
import static com.individuals3.backend_football.constant.SecurityConstant.JWT_TOKEN_HEADER;
...
public class UserResource extends ExceptionHandling {
    ...
    public ResponseEntity<User> update(@RequestParam("currentUsername") String currentUsername,
                                       ...
                                       @RequestParam("isActive") String isActive,
                                       @RequestParam("isNonLocked") String isNonLocked,
                                       @RequestParam(value = "profileImage", required = false) MultipartFile profileImage) throws UserNotFoundException, IOException, NotAnImageFileException, UsernameExistsException, EmailExistsException {
    ...
    public ResponseEntity<List<User>> getAvailablePlayers() {
        List<User> players = userService.getAvailablePlayers();
